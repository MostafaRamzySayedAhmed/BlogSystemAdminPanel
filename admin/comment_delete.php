	...
	
   {
    ...
    $count = $sql->rowCount();
					...
					
				{
					...
					$comment_delete_success = "<span class='alert alert-success'>Record Deleted Successfully</span>";
				...
				
				{
					...
					$comment_delete_error = "<span class='alert alert-danger'>This ID Is NOT Existed</span>";
