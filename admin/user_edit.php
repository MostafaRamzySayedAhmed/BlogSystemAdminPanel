...
if(isset($_SESSION['Username']))
	
   {
	   ...
	   echo "<h1 class='edit text-center'>Edit User</h1>";
	...
	<div class="container">
		...
		<div class="form-group">
			...
			<div class="col-sm-4 col-md-6">
				<input class="form-control" type="text" name="username" autocomplete="off" required value="<?php echo $user['Username'];?>">
		...
		<div class="form-group">
			...
			<div class="col-sm-4 col-md-6">
				<input class="form-control" type="password" name="password" placeholder="Leave Blank If You Don't Want To Change It" value=" <?php echo $user['Password'] ?>">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-4 col-md-6">
				<input class="form-control" type="email" name="email" auto-complete="off" required value="<?php echo $user['Email'];?>">
				<span class="asterisk">*</span>
			</div>
...
<?php
	   ...
	   
	   		{
				...
				$user_edit_error = '<div class="alert alert-danger">Theres No Such ID</div>';

				redirect_home($user_edit_error);
	...
	
	{
			 ...
			 $user_edit_error = "<span class='message-error alert alert-danger'>You Are Not Permited To Access This Page Directly</span>";
			 
			 redirect_home($user_edit_error, 5);
