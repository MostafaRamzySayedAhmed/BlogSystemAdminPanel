	   ...
	   // Check If Get Request catid Is Numeric & Get The Integer Value Of It
        ...
        $count = $sql->rowCount();
					...
					
				{
                    ...
                    $sql = $conn->prepare("DELETE FROM categories WHERE CategoryID = :id");

					$sql->bindParam(":id", $catid);

					$sql->execute();

					$category_delete_success = "<span class='alert alert-success'>Record Deleted Successfully</span>";
				...
				
				{
					...
					$category_delete_error = "<span class='alert alert-danger'>This ID Is NOT Existed</span>";
