...
if(isset($_SESSION['Username']))
	
   {
	...
	<h1 class="edit text-center">Add User</h1>
	...
	<div class="container">
		...
		<div class="form-group">
			...
			<input type="submit" class="btn btn-success form-control" value="Add User">
			</div>
...
<?php
	...
	
	{
		...
		$user_add = "<span class='message-error alert alert-danger'>You Are Not Permited To Access This Page Directly</span>";
			 
		redirect_home($user_add, 5);
