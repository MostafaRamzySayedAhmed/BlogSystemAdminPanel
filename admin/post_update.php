...
$sql->execute(array($posttitle, $content, $user, $category, $tags, $image_name_random, $postid));
                

					$update_message_success = "<span class='alert alert-success'>Record Updated Successfully</span>";

					
					redirect_posts($update_message_success);
	...
	
		 {
			 ...
			 $post_update_error = "<span class='message-error alert alert-danger'>You Are Not Permited To Access This Page Directly</span>";
			 
			 redirect_home($post_update_error, 5);
